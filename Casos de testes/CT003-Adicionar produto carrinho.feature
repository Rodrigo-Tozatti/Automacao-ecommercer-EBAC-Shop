...
Cenário: Validar mensagem ao adicionar mais de 10 itens do mesmo produto ao carrinho
Dado que eu acesse a página de produtos da EBAC-Shop
...
Cenário: Validar mensagem quando o valor de uma compra ultrapassar R$ 990,00
Dado que eu acesse a página de produtos da EBAC-Shop
Quando eu comprar o <produto> desejado
